...
\begin{figure}[H]
  ...
  \caption{Cosine distance plot where $x$ is the angle between two vectors.}
...
different speakers and the subspace dimension is set to two in order
...
\item An euclidian distance with a normalized data is strictly equivalent to a cosine distance;
