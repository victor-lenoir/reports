...
\paragraph{Voice activity detection} TODO
\paragraph{Speaker diarization} TODO

\subsection{Modeling}
%TODO
%We build probabilistic models based on the previously extracted fea-
%tures in order to represent one specific speaker. The main focuses are what models are
%used and how they are trained.
\subsection{Dimension reduction}
%TODO
\subsection{Scoring}
%Given a trained speaker model, we want to determine how well it per-
%forms. This is done by comparing false alarm percentages to miss percentages. This phase
%also allows us to adjust our model according to how much false alarm we want to tolerate
%compared to misses.
